...
// Upstream source: glsl/Restore/Anime4K_Clamp_Highlights.glsl:73
// Pass: 002 - Anime4K-v4.0-De-Ring-Clamp
...
#define STATSMAX_tex(position) Anime4KSample1(position)
#define STATSMAX_texOff(offset) Anime4KLoadOffset1(anime4k_output_pixel, offset)
#define STATSMAX_texCurrent Anime4KLoadCurrent1(anime4k_output_pixel)
#define STATSMAX_pos anime4k_pos
#define STATSMAX_size float2(Anime4KInputSizes[1].xy)
#define STATSMAX_pt rcp(STATSMAX_size)
