...
// Two seconds of a deterministic 320x180 VP9/WebM frame sequence, checked in
// at tests/fixtures/fixture.webm so the harness stays independent of ffmpeg.
const VIDEO = readFileSync(fileURLToPath(new URL('../fixtures/fixture.webm', import.meta.url)));
